      ...
      <div className={ styles.sobreNos }>
        ...
        <div className={ styles.sobreNos__texto }>
          <p>
            ...
            excelente qualidade para que sua experiência seja 
            ainda mais intensa!
          </p>
          <p>
          ...
          <p>
            Para acompanhar as massas italianas, Aluroni possui 
            uma reserva de vinhos especiais, que harmonizam 
